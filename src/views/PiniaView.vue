...
<template>
  <div class="py-8">
    <div class="mx-auto max-w-3xl">
      ...
      <form @submit="handleSubmit" class="mb-6">
        <div class="flex gap-4">
          ...
          <button
            ...
            :disabled="todoStore.isLoading || !newTodoTitle.trim()"
          >
            Add Todo
          </button>
        </div>
      ...
      <!-- Loading State -->
      <div v-if="todoStore.isLoading" class="flex justify-center my-8">
      ...
      <div v-else class="bg-white shadow sm:rounded-lg divide-y">
        ...
        >
          <button @click="todoStore.toggleTodo(todo)" class="flex items-center">
            <div
      ...
      <!-- Empty State -->
      <div
        v-if="!todoStore.isLoading && todoStore.todos.length === 0"
